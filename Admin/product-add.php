...
error_reporting(0);
	...
	if(isset($_POST['add_product']))
	{
		...
		$price = $_POST['price'];
		$postdetailss = mysqli_real_escape_string($con, $postdetails);
		...
		else
		{
			...
			move_uploaded_file($_FILES["postimage"]["tmp_name"],"productimages/".$imgnewfile);

			$status=1;
			$query=mysqli_query($con,"insert into tblproducts(ProductTitle,CategoryId,Details,Is_Active,PostImage,price) values('$ProductTitle','$catid','$postdetailss','$status','$imgnewfile','$price')");
			if($query)
			{
...
<html class="fixed">
	<head>
		...
		<title>Products Add | Admin</title>
									...
									<div class="panel-body">
										<form class="form-horizontal form-bordered" method="POST" enctype="multipart/form-data">
											...
											<div class="form-group">
												...
												<div class="col-md-10">
													<textarea class="summernote"  name="details" data-plugin-summernote data-plugin-options='{ "height": 180, "codemirror": { "theme": "ambiance" } }'></textarea>
												</div>
											</div>
											<div class="form-group">
